class AppwriteConstants {
  ...
  static const String endPoint = 'http://10.0.22.174:80/v1';
  ...
  static String imageUrl(String imageID) => '$endPoint/storage/buckets/$storageImagesBucket/files/$imageID/view?project=$projectId&mode=admin';
}
